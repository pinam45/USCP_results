...
# Execute
cd build/bin
./solver --output_prefix="${solveroutputfolder}/${crossover_operator}/${instance}-${crossover_operator}_" --greedy --memetic --memetic_rwls_steps=150000 --memetic_time=36000 --memetic_crossover="${crossover_operator}" --repetitions=1 --instances="${instance}"
