...
generations=${2}
instance=${3}
rwls_steps=$(expr 100000000 / ${generations} / 2)
...
# Execute
cd build/bin
./solver --output_prefix="${solveroutputfolder}/${crossover_operator}/${generations}g/${instance}-${crossover_operator}-${generations}g_" --greedy --memetic --memetic_generations="${generations}" --memetic_rwls_steps="${rwls_steps}" --memetic_crossover="${crossover_operator}" --repetitions=1 --instances="${instance}"
